...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const ownerNumber = ["628871746203@c.us","55xxxxx"] // replace with your whatsapp number
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://saweria.co/donate/DepinBau', donate)
            break
        case '!tts':
